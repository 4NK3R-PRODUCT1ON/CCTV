...
def german():
    ...
    print("  |_____.--.__()_|")
    print("  |AN //# \\\ AN|")
    print("{}  |KE  \\\__//  KE| ").format(w)
    print("  |R   '--'   R| ")
    print("{}  '--------------'----------{}------------------.  ").format(r,w)
    print("{}  | {}Author  : {}ANKER {}   | {}INDO{}N{}{}ESIA     | ").format(r,w,r,w,r,ir,reset,w)
    print("{}  | {}Youtube : {}ANKER PRODUCTION     {}| {}+1 (234) 985-0607 {}|").format(r,w,w,w,lgray,w)
    print("{}  '------------------------------------{}-------'  ").format(r,w)
...
def run():
    try:
        ...
        print ""
        print r+"Terimakasih Buat Lu Semua bray..."+w
